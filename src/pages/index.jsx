    ...
    <>
      <div className={styles.bodyContainer}>
        ...
        <div className={styles.footer}>
          ...
          <Link className={styles.gitHub_link} href="https://github.com/DomCasmurroPodcast/DomCasmurroPodcast.github.io">
            <Image className={styles.gitHub_image} src="/imgs/Github_Logo.svg" width={100} height={100} alt="Veja código no GitHub"/>
          </Link>
        </div>
      </div>
    </>
