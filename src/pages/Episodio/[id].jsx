...
export default function Page() {
  ...
  const src = "/Audio/Episodes/" + episodio?.audioSrc;
  ...
  return (
    <>
      ...
      <div className={styles.content}>
        ...
        {audioClicked &&
          !podeCarregar && ( //Aqui deve botar uma animação de loading enquanto o audio carrega
        ...
        <div className={styles.informacoes}>
          <p className={styles.alunos}>
            <b>Alunos: </b>
            {episodio?.alunos}
          </p>
          <p className={styles.turma}>
            <b>Turma: </b>
            {episodio?.turma} informática
          </p>
        </div>
        ...
        <div className={styles.footer}>
          {!(router.query.id == 1) && windowWidth > 700 && (
            <div className={styles.epAnterior}>
              ...
              <Link
                className={styles.linkEp}
                href={`/Episodio/${episodioAnterior?.id}`}
              >
                <EpisodioButton
            ...
            <div className={styles.epAnterior}>
              ...
              >
                <Button text="" className={styles.epButton}>
                  ...
                  >
                    <path
                      d="M0.900025 11.5L19.8 0.588078L19.8 22.4119L0.900025 11.5Z"
                      fill="#193441"
                    />
                  </svg>
                </Button>
          ...
          {!(router.query.id == episodios.length) && windowWidth > 700 && (
            <div className={styles.epProximo}>
              ...
              <Link
                className={styles.linkEp}
                href={`/Episodio/${episodioProximo?.id}`}
              >
                <EpisodioButton
            ...
            <div className={styles.epProximo}>
              ...
              >
                <Button text="">
                  ...
                  >
                    <path
                      d="M18.315 11.5L0.585797 22.4119L0.585798 0.588081L18.315 11.5Z"
                      fill="#193441"
                    />
                  </svg>
                </Button>
